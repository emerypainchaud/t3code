        ...
        toastManager.update(resolvedProgressToastId, {
          ...
          ...(shouldOfferPushCta
            ...
            : shouldOfferOpenPrCta
              ? {
                  actionProps: {
                    children: openReviewRequestLabel(
                      result.pr.forge ?? actionStatus?.pr?.forge ?? actionStatus?.forge,
                    ),
                    onClick: () => {
                      const api = readNativeApi();
                      if (!api) return;
            ...
            <MenuPopup align="end" className="w-full">
              ...
              {gitStatusForActions?.branch === null && (
                <p className="px-2 py-1.5 text-xs text-warning">
                  Detached HEAD: create and checkout a branch to enable push and review request
                  actions.
                </p>
              )}
              {gitStatusForActions &&
