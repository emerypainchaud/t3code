...
export function resolveProjectExecutionRoot(project: Pick<Project, "cwd" | "executionTarget">): string {
  return project.executionTarget.kind === "ssh" ? project.executionTarget.sync.localPath : project.cwd;
}
